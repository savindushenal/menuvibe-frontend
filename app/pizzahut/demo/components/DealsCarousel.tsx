...
// Hot Deals data - Christmas Bundles
export const dealsData: MenuItem[] = [
  {
    id: 'christmas-bundle-1',
    name: 'Christmas Bundle',
    price: 6600,
    originalPrice: 8500,
    description: '1 Large Pan Pizza + 1 Medium Pan Pizza + 2 Appetizers. Valid till 31st Dec 2025!',
    image: '/pizzahut/christmas-bundle1.jpg',
    rating: 4.9,
    reviews: 234,
    category: 'Deals',
    badge: 'CHRISTMAS',
  ...
  {
    id: 'christmas-bundle-2',
    name: 'Sweet Christmas Deal',
    price: 5200,
    originalPrice: 6800,
    description: '1 Large Pan Pizza + 1 Appetizer + 1 Chocolate Caramel Crunch or 2 Lava Cakes!',
    image: '/pizzahut/christmas-bundle2.jpg',
    rating: 4.8,
    reviews: 189,
    category: 'Deals',
    badge: 'SAVE 24%',
  ...
  {
    id: 'christmas-bundle-3',
    name: 'Ultimate Cheese Bundle',
    price: 6600,
    originalPrice: 8500,
    description: '1 Large Ultimate Cheese Crust Pizza + 1 Medium Ultimate Cheese Crust Pizza + 2 Appetizers!',
    image: '/pizzahut/christmas-bundle3.jpg',
    rating: 4.9,
    reviews: 312,
    category: 'Deals',
    badge: 'CHEESE LOVERS',
