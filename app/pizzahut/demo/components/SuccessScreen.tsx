      ...
      {isOpen && (
        <>
          ...
          >
            ...
            >
              <h1 className="text-xl md:text-2xl font-bold text-pizzahut-dark mb-2">
                Order Sent to Kitchen
              </h1>
              <p className="text-gray-500 mb-4 md:mb-6 text-sm md:text-base">
                {tableInfo 
                  ? `Sit tight. We'll be at Table ${tableInfo.table} in ~10 mins.`
                  : `Your order will be ready for pickup in ~10 mins.`
                }
              </p>
            ...
            >
              <motion.button
                onClick={onClose}
                className="px-8 py-3 bg-pizzahut-red text-white rounded-full font-semibold"
            ...
            {[...Array(20)].map((_, i) => (
              <motion.div
                ...
                style={{
                  backgroundColor: ['#EE3124', '#FFD700', '#FF4538', '#FFFFFF'][i % 4],
                  top: '40%',
                  left: '50%',
                }}
                initial={{ 
