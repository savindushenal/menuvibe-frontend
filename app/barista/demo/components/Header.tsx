          ...
          <>
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 border-b border-gray-100">
                <BaristaLogo variant="dark" size="sm" />
                <button 
                  onClick={() => setIsMenuOpen(false)}
              ...
              <div className="mx-4 mt-4 p-3 bg-barista-cream rounded-xl flex items-center gap-2">
                {tableInfo ? (
                  <MapPin className="w-4 h-4 text-barista-orange" />
                ) : (
                  <Store className="w-4 h-4 text-barista-orange" />
                )}
                <div>
                  {tableInfo ? (
                    <>
                      <p className="text-sm font-medium text-barista-dark">
                    ...
                    <>
                      <p className="text-sm font-medium text-barista-dark">Moratuwa Branch</p>
              ...
              <nav className="p-4 space-y-1">
                <motion.a
                  href="#"
                  onClick={() => setIsMenuOpen(false)}
                  className="flex items-center gap-3 px-4 py-3 rounded-xl bg-barista-orange/10 text-barista-orange font-medium"
                  whileTap={{ scale: 0.98 }}
                >
                ...
                <motion.a
                  href="#"
                  onClick={() => setIsMenuOpen(false)}
                  className="flex items-center gap-3 px-4 py-3 rounded-xl text-barista-dark hover:bg-gray-50 transition-colors"
                  whileTap={{ scale: 0.98 }}
                >
