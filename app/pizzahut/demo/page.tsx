  ...
  pizza: [
    {
      ...
      name: 'Meat Lovers',
      price: 2490,
      description: 'Pepperoni, Italian sausage, ham, beef and crispy bacon. A meat feast!',
      image: '/pizzahut/meat-lovers.jpg',
      rating: 4.9,
      reviews: 267,
      category: 'Pizza',
    ...
    },
    {
      ...
      name: 'BBQ Chicken',
      price: 2090,
      description: 'Grilled chicken, bacon, and onions with smoky BBQ sauce.',
      image: '/pizzahut/bbq-chicken.jpg',
      rating: 4.7,
      reviews: 198,
      category: 'Pizza',
      sizes: defaultPizzaSizes,
    ...
    },
    {
      ...
      name: 'Hawaiian',
      price: 1890,
      description: 'Ham and pineapple with mozzarella cheese. Sweet and savory!',
      image: '/pizzahut/hawaiian.jpg',
      rating: 4.4,
      reviews: 178,
      category: 'Pizza',
      sizes: defaultPizzaSizes,
