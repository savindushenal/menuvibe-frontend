...
export default function MenuList({ items, onItemClick }: MenuListProps) {
  return (
    ...
    >
      <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-isso-dark mb-4 md:mb-6">Menu</h2>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between">
                  <h3 className="font-semibold text-isso-dark text-base md:text-lg">{item.name}</h3>
