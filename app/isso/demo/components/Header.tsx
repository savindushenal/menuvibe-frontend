        ...
        <div className="px-4 sm:px-6 lg:px-12 py-3 md:py-4">
          <div className="flex items-center justify-between max-w-7xl mx-auto">
            ...
            <nav className="hidden lg:flex items-center gap-8">
              ...
              <a href="/dashboard/isso-stats" className="text-gray-400 hover:text-isso-coral text-xs border border-gray-200 px-2 py-1 rounded-lg transition-colors">Analytics</a>
            </nav>
