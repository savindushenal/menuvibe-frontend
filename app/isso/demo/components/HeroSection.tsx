...
export default function HeroSection({ tableInfo }: HeroSectionProps) {
  ...
  return (
    <motion.section 
      className="relative overflow-hidden bg-isso-coral"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 0.5 }}
    >
      {/* Ambient glow effects */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-isso-yellow/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-isso-teal/30 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
